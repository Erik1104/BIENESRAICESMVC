...
function validarOredireccionar (string $url) {
      ...
      $id = $_GET['id']; //tomar el id
      $id = filter_var($id, FILTER_VALIDATE_INT); //validar que el id es un entero
  
      if(!$id) {
          header("Location: ${url}"); //en caso de que no sea un entero te redirecciona a admin
      }
